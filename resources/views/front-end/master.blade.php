...
<head>
    ...
    <link rel="shortcut icon" href="{{asset("front-end-asset")}}/images/favicon.png" type="">
    ...
    <!-- font awesome style -->
    <link href="{{asset('front-end-asset')}}/css/font-awesome.min.css" rel="stylesheet" />
...
<!-- bootstrap js -->
<script src="{{asset('front-end-asset')}}/js/bootstrap.js"></script>
<!-- owl slider -->
